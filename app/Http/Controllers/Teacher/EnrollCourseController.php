...
class EnrollCourseController extends Controller
{
    ...
    {
        return view("teacher.pages.enroll-courses.index", [
    ...
    {
        return view("teacher.pages.enroll-courses.create");
    }
    ...
    public function show(User $student)
    {
        ...
        return view("teacher.pages.enroll-courses.edit", compact('student'));
    }

...
class StudentController extends Controller
{
    ...
    {
        return view("guardian.pages.users.students.index", [
    ...
    {
        return view("guardian.pages.users.students.create");
    }
    ...
    public function show(User $student)
    {
        ...
        return view("guardian.pages.users.students.edit", compact('student'));
    }

...
@section('breadcrumbs', Breadcrumbs::render('guardian.courses'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.courses.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('guardian.courses.show', $course->id) }}"
                                            class="btn btn-sm btn-success text-white" title="show">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        <a href="{{ route('guardian.courses.edit', $course->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('guardian.courses.destroy', $course->id) }}"
                                        ...
                                        <form id="destroy-item{{ $course->id }}"
                                            action="{{ route('guardian.courses.destroy', $course->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

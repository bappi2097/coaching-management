...
@section('breadcrumbs', Breadcrumbs::render('student.attendences'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <form action="{{ route('student.attendences.index') }}">
                    ...
                    {{-- <a href="{{ route('student.attendences.create') }}" class="btn btn-primary">Add Data</a> --}}
                </div>
                <form action="{{ route('student.attendences.store') }}" method="POST">
                    @csrf

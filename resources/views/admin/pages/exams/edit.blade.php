...
@section('breadcrumbs', Breadcrumbs::render('officer.exams.edit', $exam->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('officer.exams.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('officer.exams.update', $exam->id) }}" method="POST"

...
@section('breadcrumbs', Breadcrumbs::render('student.teachers'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('student.teachers.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($teachers as $teacher)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-10 rounded-circle">
                                                ...
                                                @else
                                                    <a class="" href="{{ route('student.teachers.show', $teacher->id) }}">
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('student.teachers.edit', $teacher->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('student.teachers.destroy', $teacher->id) }}"
                                        ...
                                        <form id="destroy-item{{ $teacher->id }}"
                                            action="{{ route('student.teachers.destroy', $teacher->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

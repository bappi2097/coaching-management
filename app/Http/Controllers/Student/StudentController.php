...
class StudentController extends Controller
{
    ...
    {
        return view("student.pages.users.students.index", [
    ...
    {
        return view("student.pages.users.students.create");
    }
    ...
    public function show(User $student)
    {
        ...
        return view("student.pages.users.students.edit", compact('student'));
    }

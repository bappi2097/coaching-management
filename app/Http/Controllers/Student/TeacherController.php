...
class TeacherController extends Controller
{
    ...
    {
        return view("student.pages.users.teachers.index", [
    ...
    {
        return view("student.pages.users.teachers.create");
    }
    ...
    public function show(User $teacher)
    {
        ...
        return view("student.pages.users.teachers.edit", compact('teacher'));
    }

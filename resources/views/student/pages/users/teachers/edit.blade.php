...
@section('breadcrumbs', Breadcrumbs::render('student.teachers.edit', $teacher->id))
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.teachers.update', $teacher->id) }}"
                    ...
                    <form method="POST" action="{{ route('student.teachers.update-password', $teacher->id) }}">
                        @csrf
                        @method('PUT')

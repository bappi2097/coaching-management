...
@section('breadcrumbs', Breadcrumbs::render('guardian.course-fees.create'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('guardian.course-fees.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">

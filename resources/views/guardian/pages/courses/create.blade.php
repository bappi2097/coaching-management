...
@section('breadcrumbs', Breadcrumbs::render('guardian.courses.create'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.courses.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('guardian.courses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

...
class TeacherController extends Controller
{
    ...
    {
        return view("teacher.pages.users.teachers.index", [
    ...
    {
        return view("teacher.pages.users.teachers.create");
    }
    ...
    public function show(User $teacher)
    {
        ...
        return view("teacher.pages.users.teachers.edit", compact('teacher'));
    }

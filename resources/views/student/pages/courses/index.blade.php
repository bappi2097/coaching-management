...
@section('breadcrumbs', Breadcrumbs::render('student.courses'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('student.courses.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('student.courses.edit', $course->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('student.courses.destroy', $course->id) }}"
                                        ...
                                        <form id="destroy-item{{ $course->id }}"
                                            action="{{ route('student.courses.destroy', $course->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

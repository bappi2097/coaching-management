...
@section('breadcrumbs', Breadcrumbs::render('teacher.results'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('teacher.results.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($results as $result)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <a href="{{ route('teacher.results.show', $result->id) }}"
                                        ...
                                        <a href="{{ route('teacher.results.destroy', $result->id) }}"
                                        ...
                                        <form id="destroy-item{{ $result->id }}"
                                            action="{{ route('teacher.results.destroy', $result->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

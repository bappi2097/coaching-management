...
@section('breadcrumbs', Breadcrumbs::render('guardian.enroll-courses.edit', $student->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.enroll-courses.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('guardian.enroll-courses.update', $student->id) }}" method="POST"

...
@section('breadcrumbs', Breadcrumbs::render('guardian.course-fees.edit', $courseFee->student->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.course-fees.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('guardian.course-fees.update', $courseFee->id) }}" method="POST"

...
@section('breadcrumbs', Breadcrumbs::render('student.course-fees.edit', $courseFee->student->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('student.course-fees.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('student.course-fees.update', $courseFee->id) }}" method="POST"

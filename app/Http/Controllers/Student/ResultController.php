...
class ResultController extends Controller
{
    ...
    {
        return view("student.pages.results.index", [
            "results" => Result::with(['student', 'exam', 'exam.examType'])->where("user_id", auth()->user()->id)->get(),
        ]);
    }
    ...
    {
        return view("student.pages.results.create");
    }
    ...
    public function show(Result $result)
    {
        ...
        return view("student.pages.results.edit", compact('result'));
    }

...
@section('breadcrumbs', Breadcrumbs::render('teacher.exams'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('teacher.exams.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <form id="destroy-item{{ $exam->id }}"
                                            action="{{ route('teacher.exams.destroy', $exam->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

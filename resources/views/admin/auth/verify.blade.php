            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary border-0 mb-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form">
                            <small>Before proceeding, please check your email for a verification link. If you did not
                                receive the email </small>
                            <div class="text-center">
                                <button type="button" class="btn btn-primary my-4">Resend</button>
                            </div>
                        </form>
                    </div>
                </div>

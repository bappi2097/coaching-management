...
@section('breadcrumbs', Breadcrumbs::render('guardian.course-fees'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                            ...
                            @foreach ($courseFees as $courseFee)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('guardian.course-fees.edit', $courseFee->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('guardian.course-fees.destroy', $courseFee->id) }}"
                                        ...
                                        <form id="destroy-item{{ $courseFee->id }}"
                                            action="{{ route('guardian.course-fees.destroy', $courseFee->id) }}"

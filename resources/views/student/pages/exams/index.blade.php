...
@section('breadcrumbs', Breadcrumbs::render('student.exams'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    {{-- <a href="{{ route('student.exams.create') }}" class="btn btn-primary">Add Data</a> --}}
                </div>
                            ...
                            @foreach ($exams as $exam)
                                <tr>
                                    ...
                                    {{-- <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('student.exams.edit', $exam->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('student.exams.destroy', $exam->id) }}"
                                        ...
                                        <form id="destroy-item{{ $exam->id }}"
                                            action="{{ route('student.exams.destroy', $exam->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>

...
@section('breadcrumbs', Breadcrumbs::render('officer.enroll-courses'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('officer.enroll-courses.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-10 rounded-circle">
                                                @empty($student->image)
                                                    <a href="{{ route('officer.enroll-courses.show', $student->id) }}"
                                                ...
                                                @else
                                                    <a class=""
                                                        href="{{ route('officer.enroll-courses.show', $student->id) }}">
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('officer.enroll-courses.edit', $student->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        {{-- <a href="{{ route('officer.enroll-courses.destroy', $student->id) }}"
                                        ...
                                        <form id="destroy-item{{ $student->id }}"
                                            action="{{ route('officer.enroll-courses.destroy', $student->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form> --}}

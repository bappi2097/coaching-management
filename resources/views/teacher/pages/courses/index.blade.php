...
@section('breadcrumbs', Breadcrumbs::render('teacher.courses'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('teacher.courses.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($courses as $course)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('teacher.courses.destroy', $course->id) }}"

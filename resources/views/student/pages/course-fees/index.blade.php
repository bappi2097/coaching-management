...
@section('breadcrumbs', Breadcrumbs::render('student.course-fees'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('student.course-fees.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($courseFees as $courseFee)
                                <tr>
                                    ...
                                    {{-- <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('student.course-fees.edit', $courseFee->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('student.course-fees.destroy', $courseFee->id) }}"
                                        ...
                                        <form id="destroy-item{{ $courseFee->id }}"
                                            action="{{ route('student.course-fees.destroy', $courseFee->id) }}"

...
@section('breadcrumbs', Breadcrumbs::render('officer.attendences'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <form action="{{ route('officer.attendences.index') }}">
                    ...
                    {{-- <a href="{{ route('officer.attendences.create') }}" class="btn btn-primary">Add Data</a> --}}
                </div>
                <form action="{{ route('officer.attendences.store') }}" method="POST">
                    @csrf

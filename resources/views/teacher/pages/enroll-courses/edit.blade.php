...
@section('breadcrumbs', Breadcrumbs::render('teacher.enroll-courses.edit', $student->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('teacher.enroll-courses.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('teacher.enroll-courses.update', $student->id) }}" method="POST"

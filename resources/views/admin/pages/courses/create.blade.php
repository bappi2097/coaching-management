...
@section('breadcrumbs', Breadcrumbs::render('officer.courses.create'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('officer.courses.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('officer.courses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

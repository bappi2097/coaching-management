...
@section('breadcrumbs', Breadcrumbs::render('guardian.exam-types'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.exam-types.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($examTypes as $examType)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('guardian.exam-types.show', $examType->id) }}"
                                            class="btn btn-sm btn-success text-white" title="show">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        <a href="{{ route('guardian.exam-types.edit', $examType->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('guardian.exam-types.destroy', $examType->id) }}"
                                        ...
                                        <form id="destroy-item{{ $examType->id }}"
                                            action="{{ route('guardian.exam-types.destroy', $examType->id) }}"

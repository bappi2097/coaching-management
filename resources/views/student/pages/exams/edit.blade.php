...
@section('breadcrumbs', Breadcrumbs::render('student.exams.edit', $exam->id))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('student.exams.index') }}" class="btn btn-primary">Back</a>
                </div>
                <div class="card-body">

                    <form action="{{ route('student.exams.update', $exam->id) }}" method="POST"

...
class CourseController extends Controller
{
    ...
    {
        return view("teacher.pages.courses.index", [
            "courses" => Course::get()
        ]);
    }
    ...
    {
        return view("teacher.pages.courses.create");
    }
    ...
    {
        return view("teacher.pages.courses.show", compact('course'));
    }
    ...
    {
        return view("teacher.pages.courses.edit", compact('course'));
    }

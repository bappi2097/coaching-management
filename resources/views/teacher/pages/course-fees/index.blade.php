...
@section('breadcrumbs', Breadcrumbs::render('teacher.course-fees'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('teacher.course-fees.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($courseFees as $courseFee)
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="m-r-10 rounded-circle">
                                                @empty($courseFee->student->image)
                                                    <a href="{{ route('teacher.course-fees.show', $courseFee->student->id) }}"
                                                ...
                                                @else
                                                    <a class=""
                                                        href="{{ route('teacher.course-fees.show', $courseFee->student->id) }}">
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('teacher.course-fees.show', $courseFee->id) }}"
                                            class="btn btn-sm btn-success text-white" title="show">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        <a href="{{ route('teacher.course-fees.edit', $courseFee->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('teacher.course-fees.destroy', $courseFee->id) }}"
                                        ...
                                        <form id="destroy-item{{ $courseFee->id }}"
                                            action="{{ route('teacher.course-fees.destroy', $courseFee->id) }}"

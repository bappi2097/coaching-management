...
@section('breadcrumbs', Breadcrumbs::render('guardian.enroll-courses'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <a href="{{ route('guardian.enroll-courses.edit', $student->id) }}"
                                        ...
                                        <form id="destroy-item{{ $student->id }}"
                                            action="{{ route('guardian.enroll-courses.destroy', $student->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form> --}}

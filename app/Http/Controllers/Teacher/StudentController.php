...
class StudentController extends Controller
{
    ...
    {
        return view("teacher.pages.users.students.index", [
    ...
    {
        return view("teacher.pages.users.students.create");
    }
    ...
    public function show(User $student)
    {
        ...
        return view("teacher.pages.users.students.edit", compact('student'));
    }

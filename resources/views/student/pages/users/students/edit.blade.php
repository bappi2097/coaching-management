...
@section('breadcrumbs', Breadcrumbs::render('student.students.edit', $student->id))
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4">
                            <a href="{{ route('student.enroll-courses.create') }}" class="btn btn-primary">Enroll</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('student.students.update', $student->id) }}"
                    ...
                    <form method="POST" action="{{ route('student.students.update-password', $student->id) }}">
                        @csrf
                        @method('PUT')

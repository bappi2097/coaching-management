...
@section('breadcrumbs', Breadcrumbs::render('guardian.exams'))
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('guardian.exams.create') }}" class="btn btn-primary">Add Data</a>
                </div>
                            ...
                            @foreach ($exams as $exam)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <a href="{{ route('guardian.exams.show', $exam->id) }}"
                                            class="btn btn-sm btn-success text-white" title="show">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        <a href="{{ route('guardian.exams.edit', $exam->id) }}"
                                            class="btn btn-sm btn-info text-white" title="edit">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('guardian.exams.destroy', $exam->id) }}"
                                        ...
                                        <form id="destroy-item{{ $exam->id }}"
                                            action="{{ route('guardian.exams.destroy', $exam->id) }}" method="POST"
                                            class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
